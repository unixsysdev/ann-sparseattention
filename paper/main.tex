...
the run is active. The first diagnostic is encouraging: at step 250, all32
achieves Recall@K 0.812 and +2.283\% relative PPL gap, already better than the
best observed all-36 training-eval point (+3.227\%). This is not yet a final
result; the run is continuing to step 1000. It is the right next test because it
asks whether broad substitution fails because of a few edge layers or because
small per-layer errors compound even when every individual layer has high
Mass@K.
